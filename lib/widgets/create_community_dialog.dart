                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  color: member.isEmployee ? const Color(0xFFECFDF5) : AppColors.slate100,
                                                  borderRadius: BorderRadius.circular(4),
                                                ),
                                                child: Text(
                                                  ...
                                                  style: TextStyle(
                                                    fontSize: 10,
                                                    fontWeight: FontWeight.bold,
                                                    color: member.isEmployee ? const Color(0xFF059669) : AppColors.slate500,
                                                  ),
                                                ),
                                              ),
                                            ],
                                          ...
                                          if (member.isEmployee) ...[
                                            ...
                                            Text(
                                              member.role == 'Admin' 
                                                ? 'â€¢ Can view productivity analytics of all members\nâ€¢ Can manage members and roles\nâ€¢ Can access team productivity insights'
                                                : 'â€¢ Can view only their own productivity data\nâ€¢ Cannot see analytics of other employees\nâ€¢ Cannot manage other members',
                                              style: const TextStyle(fontSize: 11, color: AppColors.slate500, height: 1.5),
                                            ),
                                          ],
                                        ],
                                      ),
