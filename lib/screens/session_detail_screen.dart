  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: AppColors.slate900),
          onPressed: () => Navigator.pop(context),
        ),
        title: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(widget.session.title, style: TextStyle(color: AppColors.slate900, fontSize: 18, fontWeight: FontWeight.bold)),
            Text('Real-time Collaborative Session', style: TextStyle(color: AppColors.slate500, fontSize: 12)),
          ],
        ),
        actions: [
        ...
        builder: (context, scrollController) => Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Provide detailed specs for the upcoming frontend refactor. Focus on mobile responsiveness and accessibility.', 
...
class _DetailRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          SizedBox(width: 120, child: Text(label, style: TextStyle(color: AppColors.slate500))),
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        CircleAvatar(radius: 14, backgroundColor: AppColors.slate100, child: Icon(Icons.add, size: 14, color: AppColors.slate500)),
      ],
    );
  }
}