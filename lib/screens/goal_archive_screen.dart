      ...
      children: [
        MouseRegion(
          ...
          child: GestureDetector(
            ...
            child: const Text('Goals', style: TextStyle(color: AppColors.slate500, fontSize: 14)),
          ),
        ),
        ...
        MouseRegion(
          ...
          child: GestureDetector(
            onTap: widget.onBack,
            child: Text(widget.goal.title, style: const TextStyle(color: AppColors.slate500, fontSize: 14)),
          ),
        ),
        const Icon(Icons.chevron_right, size: 16, color: AppColors.slate300),
        const Text('Archived Tasks', style: TextStyle(color: AppColors.primary, fontSize: 14, fontWeight: FontWeight.w500)),
      ],
    );
  }
    ...
    return PopupMenuButton<String>(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            const Icon(Icons.sort, size: 14, color: AppColors.slate500),
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(
            label,
            style: const TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: AppColors.slate400, letterSpacing: 1.5),
          ),
        ),
        ListView.separated(
          shrinkWrap: true,
            ...
            children: [
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(_formatCompletedTime(), style: const TextStyle(color: AppColors.slate500, fontSize: 13)),
                        const SizedBox(width: 16),
                        const Icon(Icons.flash_on, size: 14, color: AppColors.slate400),
                        const SizedBox(width: 4),
                        Text(_formatTimeSpent(), style: const TextStyle(color: AppColors.slate500, fontSize: 13)),
                      ],
                    ),
                  ],
                ),
              ...
              if (task.sessions.isNotEmpty)
                IconButton(
                  ...
                  icon: const Icon(Icons.info_outline, size: 20, color: AppColors.slate400),
                  splashRadius: 20,
  ...
  Widget _buildInfoMetric(String label, String value) {
    return Column(
      children: [
        Text(
          label,
          style: const TextStyle(fontSize: 9, fontWeight: FontWeight.bold, color: AppColors.slate400, letterSpacing: 1),
        ),
        const SizedBox(height: 4),
        Text(
          value,
