          ...
          Row(
            ...
            children: [
              for (var day in ['MON', 'TUE', 'WED', 'THU', 'FRI', 'SAT', 'SUN'])
                Text(day, style: const TextStyle(fontSize: 12, color: AppColors.slate400, fontWeight: FontWeight.w500)),
            ],
          ),
        ],
      ),
    ...
    return Column(
      ...
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text(label, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: AppColors.slate400)),
            Text('${(progress * 100).toInt()}%', style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.slate500)),
          ],
        ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        member.email, 
                        style: const TextStyle(fontSize: 12, color: AppColors.slate500, fontWeight: FontWeight.w400)
                      ),
                    ],
                  ),
                ),
      ...
      child: Column(
        ...
        children: [
          ...
          if (community.communitySessions.isEmpty)
             const Text('No active sessions', style: TextStyle(color: AppColors.slate400))
          else
