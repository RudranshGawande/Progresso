      ...
      child: Column(
        children: [
          Container(
            ...
            child: const Icon(Icons.emoji_events, color: AppColors.primary, size: 36),
          ),
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const Text('FOCUS LEVEL', style: TextStyle(fontSize: 9, fontWeight: FontWeight.bold, color: AppColors.slate400, letterSpacing: 0.5)),
                ],
              ),
            ],
          ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          TextButton(
            onPressed: () {
               // Archive the task if requested (optional logic here)
          ...
          ElevatedButton.icon(
            ...
            icon: const Text('View Analysis', style: TextStyle(fontWeight: FontWeight.bold)),
            label: const Icon(Icons.trending_up, size: 16),
          ),
        ],
      ),
    );
