    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              const Icon(Icons.group, size: 16, color: AppColors.slate400),
              const SizedBox(width: 8),
              Text('$contributors contributors active', style: const TextStyle(fontSize: 13, color: AppColors.slate500)),
              const Spacer(),
              TextButton(
                onPressed: () {},
