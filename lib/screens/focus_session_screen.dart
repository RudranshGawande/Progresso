...
class _FocusSessionScreenState extends State<FocusSessionScreen> with TickerProviderStateMixin {
  ...
  int get _displaySeconds {
    if (_targetSeconds == null) return _elapsedSeconds;
    return (_targetSeconds! - _elapsedSeconds).clamp(0, 999999);
  }
    ...
    return Column(
      children: [
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.gps_fixed, size: 14, color: AppColors.slate400),
            const SizedBox(width: 8),
            Text(
