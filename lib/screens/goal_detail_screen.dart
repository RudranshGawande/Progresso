              ...
              child: Column(
                ...
                children: [
                   Container(
                    ...
                    child: Icon(Icons.timer_outlined, color: AppColors.primary, size: 32),
                  ),
  ...
  void _showSessionTypeSelection(GoalTask task) {
    showGeneralDialog(
      ...
      pageBuilder: (context, _, __) => SessionTypeSelectionDialog(
        goal: widget.goal,
        task: task,
        onSelect: (type, durationSeconds) {
          Navigator.pop(context);
          setState(() {
            task.sessionType = type;
            task.defaultDuration = durationSeconds > 0 ? durationSeconds : null;
          });
          _startDirectSession(task);
        },
      ),
          ...
          Row(
            children: [
              ...
              if (!isMobile) ...[
                ...
                const SizedBox(width: 16),
                Icon(Icons.notifications_none, color: AppColors.slate500, size: 20),
                const SizedBox(width: 16),
                const CircleAvatar(
                  radius: 16,
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: goal.status == GoalStatus.active ? Color(0xFFDCFCE7) : AppColors.slate100,
                          borderRadius: BorderRadius.circular(999),
                          border: Border.all(color: goal.status == GoalStatus.active ? Color(0xFFBBF7D0) : AppColors.slate200),
                        ),
                        child: Text(
                          goal.status.name.toUpperCase(),
                          style: TextStyle(
                            color: goal.status == GoalStatus.active ? Color(0xFF15803D) : AppColors.slate600,
                            fontSize: 11,
                            fontWeight: FontWeight.bold,
                          ),
                        ),
        ...
        children: [
              ...
              child: Wrap(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text('Clear All', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: AppColors.slate500)),
                  ),
                ],
              ),
            ),
          ...
          InkWell(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                   Icon(Icons.archive_outlined, size: 20, color: AppColors.slate500),
                   const SizedBox(width: 12),
                   Text(
                    'View Complete Tasks',
                    style: TextStyle(
...
class _AddTaskForm extends StatelessWidget {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              TextButton(
                onPressed: onCancel,
                child: Text('Cancel', style: TextStyle(color: AppColors.slate500, fontWeight: FontWeight.bold)),
              ),
              const SizedBox(width: 8),
              ElevatedButton.icon(
                onPressed: onSave,
  ...
  Widget _buildTaskNameField() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Task Name', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: AppColors.slate500)),
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            border: OutlineInputBorder(borderRadius: BorderRadius.circular(8), borderSide: BorderSide(color: AppColors.slate300)),
          ),
        ),
      ],
    );
  ...
  Widget _buildPriorityField(BuildContext context) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Priority', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: AppColors.slate500)),
        const SizedBox(height: 6),
        Theme(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    currentLabel,
                    style: TextStyle(fontSize: 14, color: AppColors.slate900, fontWeight: FontWeight.w500),
                  ),
                  Icon(Icons.keyboard_arrow_up, size: 20, color: AppColors.slate900),
                ],
              ),
            ),
          ),
  ...
  Widget _buildDeadlineField(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Deadline', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: AppColors.slate500)),
        const SizedBox(height: 6),
        InkWell(
          onTap: () async {
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Spacer(),
                      Icon(Icons.edit, color: AppColors.slate400, size: 20),
                    ],
                  ),
                ),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          TextButton(
                            onPressed: () => Navigator.pop(context),
                            child: Text('CANCEL', style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.bold, fontSize: 13)),
                          ),
                          const SizedBox(width: 16),
                          TextButton(
                            onPressed: () => Navigator.pop(context, _selectedDate),
                            child: Text('OK', style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.bold, fontSize: 13)),
                          ),
                        ],
                      ),
                    ],
  ...
  Widget _buildDaysOfWeek() {
    ...
    return Row(
      ...
      children: days.map((d) => SizedBox(
        width: 36,
        child: Center(
          child: Text(d, style: TextStyle(color: AppColors.slate400, fontSize: 11, fontWeight: FontWeight.bold)),
        ),
      )).toList(),
    );
  }
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: (task.priority == TaskPriority.high || task.priority == TaskPriority.milestone) && !task.isCompleted
                ? Border.all(color: task.priority == TaskPriority.high ? Color(0xFFFED7AA) : AppColors.primary.withOpacity(0.2), width: 1)
                : null,
              color: (task.priority == TaskPriority.high || task.priority == TaskPriority.milestone) && !task.isCompleted
                ? (task.priority == TaskPriority.high ? Color(0xFFFFF7ED).withOpacity(0.5) : AppColors.primary.withOpacity(0.05))
                : null,
            ),
            child: Row(
              children: [
                Checkbox(
                  ...
                  side: BorderSide(color: (task.priority == TaskPriority.high || task.priority == TaskPriority.milestone) && !task.isCompleted ? (task.priority == TaskPriority.high ? Color(0xFFFDBA74) : AppColors.primary) : AppColors.slate300),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: (task.priority == TaskPriority.high || task.priority == TaskPriority.milestone) && !task.isCompleted
                      ? Border.all(color: (task.priority == TaskPriority.high ? Color(0xFFFDBA74) : AppColors.primary).withOpacity(0.2))
                      : null,
                  ),
                  child: Text(
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 4),
          Text(
            '$label | ${SessionManager.formatDuration(elapsed)} logged',
            style: TextStyle(
              fontSize: 11,
              fontWeight: FontWeight.w500,
              color: color,
  ...
  Widget build(BuildContext context) {
    if (milestoneTask == null) {
      return Container(
        ...
        child: Center(child: Text('No upcoming milestones', style: TextStyle(color: AppColors.slate400))),
      );
    }
