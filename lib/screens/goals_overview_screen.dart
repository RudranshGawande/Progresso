      ...
      child: Row(
        children: [
          ...
          if (!isMobile) ...[
            ...
            Icon(Icons.notifications_none, color: AppColors.slate500, size: 24),
            const SizedBox(width: 16),
            const CircleAvatar(
              radius: 16,
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(label, style: TextStyle(color: AppColors.slate500, fontSize: 13, fontWeight: FontWeight.w500)),
              Container(
          ...
          Text(value, style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: AppColors.slate900)),
        ],
      ),
    );
  }
    ...
    return Column(
      ...
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text('Active Goals', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.slate900)),
            TextButton(
              onPressed: () {},
              child: Text('View All', style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.bold, fontSize: 14)),
            ),
          ],
        ),
        ...
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return _GoalCard(
              ...
              imageUrl: goal.imageUrl ?? 'assets/images/productivity.png',
            );
          },
        ),
      ],
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(title, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.slate900)),
                  const SizedBox(height: 4),
                  Text(subtitle, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 13, color: AppColors.slate500)),
                  const SizedBox(height: 12), // Reduced from 16
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Progress', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: AppColors.slate600)),
                      Text('${(progress * 100).toInt()}%', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: AppColors.primary)),
                    ],
                  ),
                  const SizedBox(height: 8),
                  ClipRRect(
                  ...
                  Row(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(Icons.check_circle, size: 14, color: AppColors.slate400),
                          const SizedBox(width: 6),
                          Text(tasks, style: TextStyle(fontSize: 11, color: AppColors.slate500)),
                        ],
                      ),
                      Container(
                        ...
                        child: Text(dueDate, style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: AppColors.slate600)),
                      ),
                    ],
                  ),
                ],
            ...
            children: [
              ...
              if (displayMilestones.isEmpty)
                ...
                ...displayMilestones.asMap().entries.map((entry) {
                  ...
                  return _MilestoneStep(
                    title: task.name,
                    subtitle: '${m['goalTitle']} | ${DateFormat('MMM dd').format(task.deadline)}',
                    isActive: idx == 0,
              ...
              SizedBox(
                ...
                child: OutlinedButton(
                  ...
                  child: Text('View Timeline', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: AppColors.slate900)),
                ),
              ),
            ],
          ),
          ...
          Expanded(
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(title, style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: AppColors.slate900)),
                  const SizedBox(height: 2),
                  Text(subtitle, style: TextStyle(fontSize: 12, color: AppColors.slate500)),
                ],
              ),
            ),
          ),
