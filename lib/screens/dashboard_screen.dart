...
class DashboardScreen extends StatelessWidget {
  ...
  Widget _buildStatCards(BuildContext context, List<Goal> goals) {
    ...
    final hoursTrendIcon = hoursTrend >= 0 || (hoursTrend == 0 && totalHoursThisWeek == 0) ? Icons.trending_up : Icons.trending_down;
    final focusTrendColor = focusTrend >= 0 || (focusTrend == 0 && avgFocusThisWeek == 0) ? AppColors.emerald500 : AppColors.rose500;
